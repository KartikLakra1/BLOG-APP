...
const BlogCard = ({ title, image, description, name, email, date, id, isUser }) => {
    ...
    return (
        <div className="w-[100%] md:w-[90%] lg:w-[100%] shadow-3xl bg-white rounded-lg  text-black p-1" >
            ...
            <h1 className=" text-lg  lg:text-xl font-semibold font-sans p-2 text-left">{title}</h1>

            <hr className="mb-3" />

            <p className="m-2 text-md lg:text-md text-left">{description.substring(0, 50)} ...</p>
